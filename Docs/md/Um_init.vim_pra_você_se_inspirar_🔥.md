...
[fonte](https://www.tabnews.com.br/NathanFirmo/um-init-vim-pra-voce-se-inspirar)

## Link para uma gist com o arquivo completo 🗂️

Se você quiser copiar todo o arquivo para usar no seu vim, pode acessar por [aqui](https://github.com/NathanFirmo/dotfiles/blob/main/.config/nvim/base-config.vim).
...
![neovim](https://i.ibb.co/FhXtxpS/Captura-de-tela-de-2022-06-01-00-22-02.png)

Se você gostou do conteúdo, confira meu [outro post sobre neovim](https://www.tabnews.com.br/NathanFirmo/a-melhor-ide-que-voce-vera-hoje) em que eu mostro minhas novas configurações utilizando a linguagem lua! 🌔

> Esse é o visual da nova configuraçao

![lsp](https://i.ibb.co/xHkmNMP/Captura-de-tela-de-2022-06-07-22-19-00.png)