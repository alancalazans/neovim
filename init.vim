...
" {{{
	...
	" Mapeamentos do auto-pairs
	" Isso evita que ele interfira na digitação normal
" }}}
"-------------------------------------------------------
"--- Desativando mapeamentos do auto-pairs evitando  ---
"--- a interferência na digitação normal             ---
"-------------------------------------------------------
" {{{
	let g:AutoPairsMapSpace = 0 " Mapeamento do SPACE
	let g:AutoPairsMapBS = 0    " Mapeamento do BACKSPACE
	let g:AutoPairsMapCR = 0    " Mapeamento do ENTER
" }}}
"-----------
"--- ALE ---
"-----------
...
"----------------------------------
" {{{
	set lazyredraw    " Evita redesenhos intermediários
	set synmaxcol=200 " Limita syntax highlighting a 200 colunas
" }}}
"----------------------------------------------------
